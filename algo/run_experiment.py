...
from sts.algo.run_sts_experiment import run_use_sts_experiment, run_laser_sts_experiment, run_sbert_sts_experiment
...
def run_multilingual_sbert_experiment(list_1, list_2, result_file, run_sts_experiment=False, batch_size=8, threshold=0.8, cleaning=True, max_no=None, random_seed=777):

    if run_sts_experiment:
        run_sbert_sts_experiment(cleaning)
